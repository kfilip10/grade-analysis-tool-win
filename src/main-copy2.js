...
//const { app,session, BrowserWindow } = require('electron'); //from electron builder
...
//const { waitFor, randomPort, getRPath } = require('./helpers')
import { randomPort, waitFor, getRPath } from './helpers.mjs'
console.log("inside main.mjs")
...
app.on('ready', async () => { //removed this based on electron tutorial KTF
//app.whenReady().then(() => {
